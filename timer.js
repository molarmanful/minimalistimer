var time, scramble;
var startTimer=function(t){this.start_t=null,this.interval=null,this.DOM=t,this.toggle=function(){null==this.interval?this.start():this.end()},this.start=function(t){this.start_t=new Date;var i=this,n=function(){i.update(t)};this.interval=setInterval(n,10)},this.end=function(){clearInterval(this.interval),this.interval=null},this.update=function(t){var i=(new Date-this.start_t)/1e3,n=60>i?0:Math.floor(Math.floor(i)/60);i=(i%60).toFixed(3),this.DOM.innerHTML=n.toString()+":"+i,time=n.toString()+":"+i,void 0!=t&&(this.DOM.innerHTML=t)}};
