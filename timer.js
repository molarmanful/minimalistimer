...
function updatestats(){
  ...
  if(times[sn].length > 0){
    ...
    if(times[sn].length > 2){
      ...
      $('#sa').text(jChester.solveTimeToStopwatchFormat({millis: st(dup).average(), decimals: 3}));
    }
    ...
    if(times[sn].length > 4){
      ...
      dup.splice(dup.indexOf(sort[times[sn].length - 1]), 1)
      dup.splice(dup.indexOf(sort[0]), 1);
      $('#aof').text(jChester.solveTimeToStopwatchFormat({millis: st(dup).average(), decimals: 3}));
    }
    ...
    if(times[sn].length > 11){
      ...
      dup.splice(dup.indexOf(sort[times[sn].length - 1]), 1)
      dup.splice(dup.indexOf(sort[0]), 1);
      $('#aot').text(jChester.solveTimeToStopwatchFormat({millis: st(dup).average(), decimals: 3}));
    }
    ...
    if(times[sn].length > 99){
      ...
      dup.splice(dup.indexOf(sort[times[sn].length - 1]), 1)
      dup.splice(dup.indexOf(sort[0]), 1);
      $('#aoh').text(jChester.solveTimeToStopwatchFormat({millis: st(dup).average(), decimals: 3}));
    }
